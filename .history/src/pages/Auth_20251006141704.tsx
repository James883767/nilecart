...
const Auth = () => {
  ...
  useEffect(() => {
    ...
    if (!authLoading && user) {
      // If we have a profile with a role, redirect based on role
      if (profile && profile.role) {
        ...
        // If no profile yet, redirect to home as fallback
        console.log('User authenticated but no profile or role found - redirecting to home');
