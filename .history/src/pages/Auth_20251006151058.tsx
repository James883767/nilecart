  ...
  useEffect(() => {
    ...
    if (!authLoading && user) {
      ...
      if (profile.role === 'seller') {
        console.log('SELLER DETECTED - Redirecting to dashboard');
        navigate('/dashboard');
      } else {
        console.log('NOT SELLER (role:', profile.role, ') - Redirecting to home');
        navigate('/home');
      }
    } else {
      console.log('Not ready to redirect yet - loading:', authLoading, 'user:', !!user);
    }
