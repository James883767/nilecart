...
import { landingPageBanners } from '@/data/banners';
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8">
        <StaticBanner
          image={landingPageBanners[0].image}
          title={landingPageBanners[0].title}
          subtitle={landingPageBanners[0].subtitle}
          buttonText={landingPageBanners[0].buttonText}
          buttonLink={landingPageBanners[0].buttonLink}
